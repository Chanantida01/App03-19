...
@Component({
  ...
  standalone: true,
  imports: [IonHeader, IonToolbar, IonTitle, IonContent, IonInput, IonLabel, IonItem, IonButton, IonModal, IonButtons, IonAvatar, IonImg, IonList, IonCheckbox, IonSearchbar]
})
